...
// Absolute overlays must restore vacated underlay rows after shrink/grow/remove.
    ["verify-overlay-shrink-restore", ['node', '--import', 'tsx/esm', 'scripts/verify-overlay-shrink-restore.tsx']],
