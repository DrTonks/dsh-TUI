...
export function Chat({
  ...
  // The status container is a stable anchor while the absolute questionnaire
  // is open. Measure the physical rows above it instead of assuming that the
  // inline frame occupies the full terminal.
  React.useLayoutEffect(() => {
    ...
    while (parent) {
      if (parent.yogaNode) absoluteTop += parent.yogaNode.getComputedTop()
